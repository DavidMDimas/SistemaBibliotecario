...
namespace CapaDatos
{
    public class DPrestamo
    {
        ...
        public string EntregaLibros(DPrestamo Prestamo)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "SPEntregaLibros";
                SqlCmd.CommandType = CommandType.StoredProcedure;
                ...
                rpta = SqlCmd.ExecuteNonQuery() == 1 ? "Libros entregados" : "NO se modifico el Registro";
        ...
        public string SancionPrestamo(DPrestamo Prestamo)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "SPSancionarPrestamo";
                SqlCmd.CommandType = CommandType.StoredProcedure;
                ...
                rpta = SqlCmd.ExecuteNonQuery() == 1 ? "Sancion" : "NO se pudo sancionar";
        ...
        public DataTable BuscarAlumnoPrestamo(DPrestamo Prestamo)
        {
        ...
        public DataTable BuscarLibrosPrestadosMatricula(DPrestamo Prestamo)
        {
            ...
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "SPMostrarPrestamosMatricula";
                SqlCmd.CommandType = CommandType.StoredProcedure;
